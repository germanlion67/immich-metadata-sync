...
| Album-Beschreibung (aus Album-API) | (noch nicht zugewiesen) | Potenziell in `XMP:Description` oder separates Feld. | "Testalbum Beschreibung" | Geplant | Zukünftig; vermeidet Konflikte mit Asset-Beschreibung. |
